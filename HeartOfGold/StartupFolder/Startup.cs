...
namespace HeartOfGold
{
    public class Startup
    {
        ...
        private string GetConnectionString()
        {
            ...
            var sqlConnectionString = $"Server = tcp:HeartOfGold.database.windows.net,1433; Initial Catalog = HeartOfGold; Persist Security Info = False; User ID = { user }; Password ={ pwd }; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30";
